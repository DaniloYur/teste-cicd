// nConstantes
var MASK_NATUREZA_DESPESA       = "#.#.##.##.##";
var MASK_NATUREZA_RECEITA       = "####.##.##.##";
var MASK_CPF                    = "###.###.###-##";
var MASK_CNPJ                   = "##.###.###/####-##"; 
var MASK_DATA                   = "##/##/####";
var MASK_MATRICULA              = "####################";
...
var MASK_ACAO                   = "###";
var MASK_PT                     = "####.##.###.####.###";
var MASK_FUNCIONAL_PROGRAMATICA = "##.###.####.###";
var MASK_DOTACAO                = "###.###";
var MASK_HORA                   = "##:##";
var MASK_TEL                    = "(##) ####-####";
var MASK_TELEFONE               = "(##)#####-####";
...
var MASK_HORA_SEG               = "##:##:##";
var MASK_DATA_USA			    = "####-##-##";
var MASK_NUM_INSCRICAO          = "##.###.###/####";
var MASK_PERIODO                = "##/####";
var MASK_ANO                    = "####";
var SEPARADOR					= ";";
var MASK_PERCENTUAL				= "###.##";
var MASK_VAL_PERC_3_5           = "###,#####";
var MASK_VAL_PERC_3_4           = "###,####";
var MASK_PROTOCOLO           	= "##########";
var MASK_VALORMOEDA 		     = "########,##";
var MASK_NUMERO_PROCESSOTC       = "##.###/###/##";
var MASK_NUM_PROC_JUD_CNJ        = "#######-##.####.#.##.####";
var MASK_PERCENTUAL_3_2		     = "###,##";
/**
 * Mascara PIS
...
var MASK_LOGIN           		= "###########";
var MASK_PGE                    = "####.##.######";
//Implementaï¿½ï¿½o da ï¿½ltima Versï¿½o: Tony Caravana Campos
function _MaskAPI(){
	this.version = "0.4a";
	this.instances = 0;
	this.objects = {};
...
// seta uma mascara em um campo
// campo - objeto do tipo text que recebe a mascara
// mask  - mascara para formataï¿½ï¿½o (usar constantes);
// Arthur Bellieny
function setaMascara(campo, mask, ativarJQuery){
		var objMask = new Mask(mask, "string");
		objMask.attach(campo);
		if (campo.value != ''){
		   campo.value = objMask.format(campo.value);
		}
		
		utilizarEfeitoJQuery($(campo), mask, ativarJQuery);
}


/*MASCARA DINAMICA COM REGEX PARA TELEFONES E CELULARES
 *Gabriel Felix     14/12/2015*/
...
function setaMascaraNoInit(v){
    v.value=v.value.replace(/\D/g,"");             //Remove tudo o que nï¿½o ï¿½ dï¿½gito
    v.value=v.value.replace(/^(\d{2})(\d)/g,"($1) $2"); //Coloca parï¿½nteses em volta dos dois primeiros dï¿½gitos
...
/*
 * =========================================================
 * ----------- Funï¿½ï¿½es para Inserir o Calendario ----------- 
 * ----------- ao chamar o setaMascara para o  -------------
 * ----------- formato de data ( MASK_DATA ). --------------
 * =========================================================
 * 		INICIO
 * 
 * @author zampieri
...
function utilizarEfeitoJQuery(campo, mask, ativarJQuery){
	if(ativarJQuery == undefined || ativarJQuery){
		 ...
		 * 
		 * =========================================================
		 * ----------- Funï¿½ï¿½o para atribuir a nova ----------------- 
		 * ----------- mascara para os telefones devido ------------
		 * ----------- ao 9ï¿½ digito (chamar o setaMascara para) ----
		 * ----------- formato do telefone ( MASK_TELEFONE ). ------
		 * =========================================================
		 * 		 
		 *         INICIO
		 */
		if(mask == MASK_TELEFONE){
			campo.attr("styleClass", "telefone");
 ...
 * 
 * =========================================================
 * ----------- Funï¿½ï¿½o para limitatr o tamanho -------------- 
 * ----------- no arquivo scrips.js tem uma function -------
 * ----------- chamada limitarTamanhoTextArea() ------------
 * ----------- utiliza-la para limitar o TextArea ----------
 * =========================================================
 */
(function($){ 
    $.fn.extend({  
 ...
 * TASK1529 
 * =========================================================
 * ----------- Biblioteca MaskedInput.js para -------------- 
 * ----------- colocar mascaras esta sendo utilizada -------
 * ----------- na function que atribui novas    ------------
 * ----------- mascaras ao telefone devido ao 9ï¿½  ----------
 * =========================================================
 *     INICIO 
 */
(function($) {
