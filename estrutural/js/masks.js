...
var MASK_PGE                    = "####.##.######";
var MASK_NIT                    = "###.#####.##-#";
//Implementa��o da �ltima Vers�o: Tony Caravana Campos
function _MaskAPI(){
	this.version = "0.4a";
	this.instances = 0;
	this.objects = {};
...
// mask  - mascara para formata��o (usar constantes);
// Arthur Bellieny
...
function setaMascaraNoInit(v){
    v.value=v.value.replace(/\D/g,"");             //Remove tudo o que n�o � d�gito
    v.value=v.value.replace(/^(\d{2})(\d)/g,"($1) $2"); //Coloca par�nteses em volta dos dois primeiros d�gitos
...
/*
 * =========================================================
 * ----------- Fun��es para Inserir o Calendario ----------- 
...
function utilizarEfeitoJQuery(campo, mask, ativarJQuery){
	if(ativarJQuery == undefined || ativarJQuery){
		 ...
		 * 
		 * =========================================================
		 * ----------- Fun��o para atribuir a nova ----------------- 
		 * ----------- mascara para os telefones devido ------------
		 * ----------- ao 9� digito (chamar o setaMascara para) ----
 ...
 * ----------- mascaras ao telefone devido ao 9�  ----------
 * =========================================================
 *     INICIO 
 */
(function($) {
